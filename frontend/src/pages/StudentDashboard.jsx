...
const StudentDashboard = () => {
  ...
  // Accept/reject tutor application
                  ...
                  <div className="flex flex-col gap-1 w-full md:w-2/3">
                    ...
                    {a.status === "pending" && (
                      <div className="mt-2 flex gap-2">
                        <button onClick={() => handleApplicationStatus(a.id, "accepted")} className="px-4 py-2 bg-green-500 text-white rounded">Accept</button>
                        <button onClick={() => handleApplicationStatus(a.id, "rejected")} className="px-4 py-2 bg-red-500 text-white rounded">Reject</button>
                      </div>
                    )}
